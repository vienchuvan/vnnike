                ...
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner bg-light">
                        <div class="carousel-item active">
                            <img class="w-100 h-100" alt="Image">
                        </div>
...
// //       const productName = this.$route.params.nameProduct;

// //       return this.fetchProductByName(productName);
// //     },
// //   },
// data() {
//     return {
...
//         this.$http.get(`http://localhost:9090/api/getProductByName/${nameProduct}`)
//         .then(response => {
