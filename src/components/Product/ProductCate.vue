<template>
  <div>
    ...
    <div class="container mt-3">
      <div class="row">
        <div
          class="col-6 col-md-4 col-lg-2 mb-4 px-2"
        ...
        >
          ...
          >
            <div
              class="card mt-3 h-100 d-flex flex-column"
              style="border-radius: 15px; border: 2px solid #17a2b8"
            >
              <img
              ...
              />
              <div
                class="card-body text-center flex-grow-1 d-flex flex-column justify-content-between p-1"
              >
                <a
                  href="#"
              ...
              <div class="card-footer pt-0 border-top-0 bg-transparent">
                <div class="text-center">
                  <a
                    ...
                    role="button"
                  >
                    <span class="bi bi-cart4"></span> Giá: liên hệ
                  </a>
                </div>
              </div>
            </div>
